...
La pérdida de validation disminuyó de 0,7395 a 0,3666 y la accuracy de validation aumentó de 0,7592 a 0,8722 durante las 20 épocas. E0 es un control inicial; no es la configuración final ni habilita evaluación sobre test.
