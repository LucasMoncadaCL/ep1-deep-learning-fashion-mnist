...
- [~] **IEE 1.1.4 (1%) - Ajustes según resultados.** Evidencia: E3 selecciona learning rate 0,1; E4 mantiene batch 128 y documenta desempeño, costo y gaps para orientar E5 y Early Stopping.
...
- [~] **IEE 1.3.3 (2%) - Ajuste de hiperparámetros.** Evidencia: learning rate y batch size comparados y seleccionados en E3/E4; capacidad continúa pendiente en E5.
