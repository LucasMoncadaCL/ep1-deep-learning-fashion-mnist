...
El último comando entrena solo con train/validation y deja historia CSV, métricas JSON y curva local en el directorio de salida. No ejecutar ningún flujo que llame a evaluación sobre `X_test` durante E3--E5.
