...
- `uv --version`: pendiente.
- `python --version` dentro de `.venv`: pendiente.
- `sys.executable`: pendiente.
- comando de sincronización: pendiente.
- resultado de pruebas dentro de `.venv`: pendiente.
