...
El código reutilizable, las configuraciones, tablas y figuras se mantienen en el repositorio. La versión final pasa 31 pruebas automatizadas y Ruff. La fuente canónica es \texttt{src/ep1\_fashion\_mnist/}; el informe consolidado de las tres etapas se encuentra en \texttt{docs/latex/final/main.tex}.
