...
La decisión L2 se repitió con seed 7: sin L2 obtuvo Accuracy 0,8902 frente a 0,8863 con L2 $10^{-4}$. Los promedios locales fueron 0,8949 sin L2 y 0,8915 con L2. Una revisión externa observó una diferencia marginal e inversión en otra ejecución, por lo que L2 cero se conserva como opción prudente y trazable, sin afirmar estabilidad robusta entre entornos. Early Stopping no se implementó porque el control alcanzó su mejor validation accuracy y loss al final de las 20 épocas, sin deterioro sostenido ni ahorro material.
...
La configuración congelada se entrenó con train 54.000/validation 6.000 y se evaluó una única vez sobre los 10.000 ejemplos oficiales de test. El registro decisorio conserva el hash de F0 y las versiones del entorno; el notebook de Colab lo presenta sin volver a consultar test.
...
El código reutilizable, las configuraciones, tablas y figuras se mantienen en el repositorio. La versión final pasa 32 pruebas automatizadas y Ruff. La fuente canónica es \texttt{src/ep1\_fashion\_mnist/}; el notebook de entrega fue validado desde un entorno limpio de Colab sin repetir F1 ni consultar test. El informe consolidado de las tres etapas se encuentra en \texttt{docs/latex/final/main.tex}.
