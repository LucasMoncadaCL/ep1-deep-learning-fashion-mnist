...
\begin{tabular}{llrr}
\toprule
ID & Único cambio & Accuracy validation & F1 macro / ponderado \\
\midrule
...
Las 14 pruebas automatizadas pasan dentro de \texttt{.venv}; incluyen contrato de datos, partición, normalización, construcción de E0, salida Softmax, coherencia de configuración y el contrato explícito de métricas macro y ponderadas. El notebook \texttt{notebooks/01\_ignacio\_data\_baseline.ipynb} ejecuta desde un kernel limpio. Dado que validation tiene 600 ejemplos por clase, las métricas macro y ponderadas coinciden en E0--E2, pero ambas se almacenan para conservar un esquema completo. Lucas debe reutilizar E0 exclusivamente como control para estudiar learning rate, batch size, capacidad y Early Stopping; Cesar debe revisar este bloque antes de aceptarlo.
