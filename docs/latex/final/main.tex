...
\begin{figure}[H]
\centering
\begin{minipage}{.48\linewidth}\includegraphics[width=\linewidth]{E1_activation_validation_accuracy.png}\end{minipage}\hfill
\begin{minipage}{.48\linewidth}\includegraphics[width=\linewidth]{E2_loss_validation_accuracy.png}\end{minipage}
...
\begin{figure}[H]
\centering
\begin{minipage}{.48\linewidth}\includegraphics[width=\linewidth]{E3_learning_rate_validation_accuracy.png}\end{minipage}\hfill
\begin{minipage}{.48\linewidth}\includegraphics[width=\linewidth]{E5_capacity_validation_accuracy.png}\end{minipage}
...
\begin{figure}[H]
\centering
\begin{minipage}{.48\linewidth}\includegraphics[width=\linewidth]{E6b_retuned_optimizer_validation_accuracy.png}\end{minipage}\hfill
\begin{minipage}{.48\linewidth}\includegraphics[width=\linewidth]{E6b_retuned_optimizer_validation_loss.png}\end{minipage}
...
\begin{figure}[H]
\centering
\begin{minipage}{.48\linewidth}\includegraphics[width=\linewidth]{E7_dropout_validation_accuracy.png}\end{minipage}\hfill
\begin{minipage}{.48\linewidth}\includegraphics[width=\linewidth]{E9_l2_validation_loss.png}\end{minipage}
\caption{Curvas de validation para Dropout y L2.}
\end{figure}

\section{F0, F1 y análisis final}

La decisión L2 se repitió con seed 7: sin L2 obtuvo Accuracy 0,8902 y con L2 0,8863. Los promedios con dos seeds son 0,8949 y 0,8915 respectivamente. No se activa Early Stopping porque el control alcanza su mejor validation accuracy y loss al final de las 20 épocas, sin deterioro sostenido ni ahorro material.

F0 congela: MLP $[256,128]$, ReLU, Softmax, categorical crossentropy, SGD LR 0,1, batch 128, 20 épocas, seed 42, Dropout 0,2, sin BatchNorm, L2 ni Early Stopping. F1 entrena esta configuración conservando el split 54.000/6.000 y la evalúa una única vez sobre test.
...
La ejecución se reproduce con Python 3.12, \texttt{uv sync --frozen} y las versiones bloqueadas en \texttt{uv.lock}. El proyecto cuenta con 31 pruebas automatizadas y lint correcto. El notebook final autónomo reúne código, experimentos, gráficos y conclusiones para ejecutarse desde un runtime nuevo de Google Colab.
